...
% Reframe the affordance set as the outcome of a three-party interaction (human ⇄ agent ⇄ app): it bounds not just what the agent may *do* but what it may offer, ask, and refuse — offers are always executable, refusals are structural/explainable, required form-fields define exactly what to ask

% Limitations, ... abunch of 
